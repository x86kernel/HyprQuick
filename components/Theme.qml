...
Singleton {
    ...
    property color workspaceUrgentBg: "#d14b60"
    property color workspaceUrgentBorder: "#ff8ea0"
    property color workspaceUrgentText: "#ffe3e8"
